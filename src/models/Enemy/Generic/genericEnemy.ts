...
import { GenericCharacter } from '../../Character/genericCharacter';

export class GenericEnemy extends GenericCharacter {
  ...
  constructor(
    ...
    //最初に動く方向をランダムにセット
    this.setDirection(EnemyUtil.getRandomInt(0, 4));
  ...
  moveRamdom() {
    ...
    if (this.body.velocity.x + this.body.velocity.y === 0) {
      //4方向をランダムに選択して動かす
      const randomDir: number = EnemyUtil.getRandomInt(
        0,
        3
      );
